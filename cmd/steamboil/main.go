...
import (
	...
	"github.com/lacsar712/slabheat/internal/web"
	"github.com/lacsar712/slabheat/internal/web/api"
)
...
func main() {
	...
	go func() {
		log.Printf("slabheat listening on %s (unit %s)", cfg.ListenAddr, application.UnitID())
