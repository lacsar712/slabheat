...
function renderSnapshot(snap) {
  ...
  document.getElementById("pressure").textContent = snap.slabzone.steam_pressure_psi.toFixed(0);
  document.getElementById("mw").textContent = snap.slabzone.output_mw.toFixed(1);
  document.getElementById("slabskid-level").textContent = snap.slabskid.level_percent.toFixed(1);
  document.getElementById("burner").textContent = snap.burner.burner_phase;
  document.getElementById("o2").textContent = snap.burner.excess_o2_pct.toFixed(2);
  trendData.push(snap.slabzone.steam_pressure_psi);
